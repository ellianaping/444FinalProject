...
## Project Overview
In this  project we  compared traditional, machine learning, neural, and foundation-model. We approached a realistic business forecasting task and then explain which methods perform best and why. We forecasted room demand for the 17 hotel properties using the sample_hotels.parquet. We looked for Y daily room demand for the next 4 weeks. <www.google.com> | [google](vwww.google.com)

## Step One: prepare and validate data
The first thing we did was prepare and validate our hotel data. Based off the plots we produced, we removed hotel 28 and 77. 
